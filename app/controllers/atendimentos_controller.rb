class AtendimentosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @atendimento.update(atendimento_params)
        format.html { redirect_to @atendimento, notice: "Atendimento was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to atendimentos_path, notice: "Atendimento was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def atendimento_params
      params.require(:atendimento).permit(:paciente_id, :tipo_paciente, :data_entrada, :encaminhamento, :status, :observacoes)
    end
end
